...
import { Send, ChevronDown, Info, Menu } from "lucide-react";
...
export function ChatArea({
  ...
  if (!selectedContact) {
    // If on mobile and no contact is selected, the sidebar Sheet is visible.
    // Return an empty div for the ChatArea to prevent the welcome screen from showing 
    // behind the sidebar sheet, which is open by default when no contact is selected.
    if (isMobile) {
